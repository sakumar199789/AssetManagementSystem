...
<table id="customers" align=center>
  ...
  <c:forEach items="${sessionScope.assetList}" var="id">
	...
	<tr><td><c:out value="${id.assetId}"/></td><td><c:out value="${id.assetName}"/></td><td><a href="AssetController?action=Find&id=${id.assetId}&name=${id.assetName}">View Status</a></td></tr>
